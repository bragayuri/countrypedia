...
import pointerCircled from 'src/assets/svg/pointerCircled.svg'
...
const Carousel: React.FC<CarouselProps> = ({ cards }) => {
  ...
  const [_, setScrollable] = useState(false)
    ...
    <CarouselContainer>
      {!oneItem && (
        <button onClick={movePrev}>
          <Icon
            alt="leftPointerCarousel"
            id="carouselLeftPointer"
            svg={pointerCircled}
            width={32}
            height={32}
          />
